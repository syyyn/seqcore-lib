...
describe('URI', function() {
  ...
  it('parses uri strings correctly (test vector)', function() {
    ...
    uri = URI.parse('sequence:');
    expect(uri.address).to.be.undefined();
    expect(uri.amount).to.be.undefined();
    expect(uri.otherParam).to.be.undefined();

    uri = URI.parse('sequence:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');
    uri.address.should.equal('LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');
    expect(uri.amount).to.be.undefined();
    expect(uri.otherParam).to.be.undefined();

    uri = URI.parse('sequence:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=123.22');
    uri.address.should.equal('LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');
  ...
  it('URIs can be validated statically (test vector)', function() {
    URI.isValid('sequence:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3').should.equal(true);
    URI.isValid('sequence:mkYY5NRvikVBY1EPtaq9fAFgquesdjqECw').should.equal(true);

    URI.isValid('sequence:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.2')
                .should.equal(true);
    URI.isValid('sequence:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.2&other=param')
                .should.equal(true);
    URI.isValid('sequence:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.2&req-other=param',
                ['req-other']).should.equal(true);
    URI.isValid('sequence:mmrqEBJxUCf42vdb3oozZtyz5mKr3Vb2Em?amount=0.1&' +
                'r=https%3A%2F%2Ftest.bitpay.com%2Fi%2F6DKgf8cnJC388irbXk5hHu').should.equal(true);

    URI.isValid('sequence:').should.equal(false);
    URI.isValid('sequence:badUri').should.equal(false);
    URI.isValid('sequence:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=bad').should.equal(false);
    URI.isValid('sequence:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.2&req-other=param')
                .should.equal(false);
    URI.isValid('sequence:?r=https%3A%2F%2Ftest.bitpay.com%2Fi%2F6DKgf8cnJC388irbXk5hHu')
                .should.equal(false);
  });
  ...
  it('do not need new keyword', function() {
    var uri = URI('sequence:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');
    uri.should.be.instanceof(URI);
  });

  describe('instantiation from sequence uri', function() {
    /* jshint maxstatements: 25 */
    var uri;

    it('parses address', function() {
      uri = new URI('sequence:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');
      uri.address.should.be.instanceof(bitcore.Address);
      uri.network.should.equal(Networks.livenet);
    });

    it('parses amount', function() {
      uri = URI.fromString('sequence:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=123.22');
    ...
    it('parses a testnet address', function() {
      uri = new URI('sequence:mkYY5NRvikVBY1EPtaq9fAFgquesdjqECw');
      uri.address.should.be.instanceof(bitcore.Address);
      uri.network.should.equal(Networks.testnet);
    });

    it('stores unknown parameters as "extras"', function() {
      uri = new URI('sequence:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.2&other=param');
      uri.address.should.be.instanceof(bitcore.Address);
    ...
    it('throws error when a required feature is not supported', function() {
      (function() {
        return new URI('sequence:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.2&other=param&req-required=param');
      }).should.throw(Error);
    });
  ...
  it('should support double slash scheme', function() {
    var uri = new URI('sequence://LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');
    uri.address.toString().should.equal('LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');
  });

  it('should input/output String', function() {
    var str = 'sequence:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?' +
  ...
  it('should support numeric amounts', function() {
    var uri = new URI('sequence:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=12.10001');
  ...
  it('should generate a valid URI', function() {
    new URI({
      ...
      'sequence:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3'
    );
    ...
    new URI({
      ...
      'sequence:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3?amount=1.10001&message=Hello%20World&something=else'
    );
  ...
  it('should be case insensitive to protocol', function() {
    ...
    var uri2 = new URI('sequence:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3');

    uri1.address.toString().should.equal(uri2.address.toString());
  });

  it('writes correctly the "r" parameter on string serialization', function() {
    var originalString = 'sequence:mmrqEBJxUCf42vdb3oozZtyz5mKr3Vb2Em?amount=0.1&' +
  ...
  it('displays nicely on the console (#inspect)', function() {
    var uri = 'sequence:LXc3QtfC179bxQV83r3XaFKfsgXsKGeZv3';
