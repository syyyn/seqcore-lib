...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'http://seqcore.io/guide/transaction.html#serialization-checks';
 ...
 * and a slightly fancier format recognized by seqcore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a seqcore Address object. The
 * same is true for `script`, which can be a string or a seqcore Script.
 *
